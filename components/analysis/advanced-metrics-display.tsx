          ...
          <div>
            ...
            <div className="space-y-1 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">${analysis.acquisition.total_acquisition_cost.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="space-y-1 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-green-600">
                  ${(analysis.acquisition.total_acquisition_cost * metrics.equity_multiple).toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
